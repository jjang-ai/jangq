...
TURNS = [
    ...
    ("t1_factual",
     ...
     "In one short paragraph, what is the capital of Japan and why did it move there?", 700),
    ("t2_arith_recall",
     "What is 84 * 3 / 2? Show the two steps. Also, what did I say my toolkit is called?", 700),
    ("t3_long_instruction",
     "Write a 4-bullet release checklist for shipping a quantized model bundle. "
     "Each bullet must be one sentence. Then, on a final line, restate my name.", 900),
    ("t4_code_structured",
     ...
     "Then output a JSON object {\"name\": <my name>, \"toolkit\": <my toolkit>} on the last line.", 1200),
]
